...
// 这里填写[你的数据库地址]
const IPAddress='rm-bp181t0u622goelj9.mysql.rds.aliyuncs.com'//因为这里是要链接远程数据库，ip 地址是 mysql 的地址！！本地就是 127.0.0.1，服务器上就自己找找看

// [mysql 用户名]
const UserName='huxiaoan'

// [mysql 密码]
const PWD='520520hxa'

// [要操作的数据库名]
const DBName='babyalot'
...
app.get('/test',(req,res)=>{ //这里的是 get 方法 getUser，对应了刚才的页面发来的请求。就会执行这个方法。
  ...
  connection.query("select * from story",function(error,results,fields){//执行查找语句
